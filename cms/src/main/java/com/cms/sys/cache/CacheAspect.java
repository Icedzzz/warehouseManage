...
public class CacheAspect {
    ...
    private static final String POINTCUT_DEPT_UPDATE="execution(* com.cms.sys.service.impl.DeptServiceImpl.updateById(..))";
    private static final String POINTCUT_DEPT_GET="execution(* com.cms.sys.service.impl.DeptServiceImpl.getOne(..))";
    private static final String POINTCUT_DEPT_DELETE="execution(* com.cms.sys.service.impl.DeptServiceImpl.removeById(..))";
